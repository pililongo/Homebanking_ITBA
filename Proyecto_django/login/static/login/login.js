...
function registro(){
    if(window.innerWidth > 850){
        formulario__registro.style.display = 'grid';
...
const errorlist_login = document.querySelector('.formulario_login .errorlist')
const errorlist_registro = document.querySelector('.formulario_registro .errorlist')

if (errorlist_login) formulario__login.style.padding = '50px 20px'
if (errorlist_registro) formulario__registro.style.padding = '50px 20px'
